...
<article>
  <div style="height: 100px; ">
        ...
        <input type="text" name="edit" style="width: 50%;height: 40px; margin-left: 6%;" value="Nhập thông muốn chỉnh sửa"> <button id="edit" style="height: 40px; width: 20%; background-color: #2b3d52; border: 0px solid; color: #ffffff;">Tìm kiếm</button>
        </form>
    </div>
    ...
    <div style="margin-left: 10%; ">
       ...
       <table border="1px" cellspacing="0" id="table1">
          <tr>
            <td colspan="6"><b>Danh sách sản phẩm tim kiem</b></td>
          </tr>
          <tr >
            <td >Id</td>
            ...
            <td style="width: 100px;" colspan="2">Chỉnh sửa</td>
          </tr>
          <?php
          include('connect.php');
          $timkiem=$_POST['edit'];
          if(isset($timkiem)){
           $query="SELECT * from thongke Where TenSP like '%$timkiem'";
          ...
          if($result->num_rows >0){
            ...
            while ($rows=$result->fetch_assoc()) {
              ...
              <tr valign="top">
                ...
                <td><?=$rows["TongTien"]?> </td>
                <td >
                 <button name="action_edit"  style="height: 25px; width: 60px; background: orange;">
                      <a href="edit1.php?Id=<?php echo $rows["Id"];?>">Sửa</a>
                 </button>
                </td>
              </tr>
               </form>
